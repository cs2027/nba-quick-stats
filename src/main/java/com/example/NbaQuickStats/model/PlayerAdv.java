...
public class PlayerAdv {
    ...
    public PlayerAdv(int id, double pts, double ast, double reb, double stl, double blk, double fgPct, double threePtPct, double ftPct, String name, String teamName) {
        this.id = id;
        this.pts = pts;
        this.ast = ast;
        this.reb = reb;
